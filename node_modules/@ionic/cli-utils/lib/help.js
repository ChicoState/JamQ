...
function getListOfNamespaceDetails(env, commands) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return entries.map((v, i) => {
            ...
            const wrappedDescription = format_1.wordWrap(`${namespaceIsDeprecated(v[1]) ? chalk.yellow.bold('(deprecated)') + ' ' : ''}${nsDescMap.get(v[0])} ${chalk.dim('(subcommands:')} ${subcommands}${chalk.dim(')')}`, { indentation: HELP_DOTS_WIDTH + 6 });
