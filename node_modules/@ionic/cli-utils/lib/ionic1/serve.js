...
function createHttpServer(env, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const [WebSocket, express] = yield Promise.all([Promise.resolve().then(() => require('ws')), Promise.resolve().then(() => require('express'))]);
...
function setupProxies(env, app) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const url = yield Promise.resolve().then(() => require('url'));
        const project = yield env.project.load();
        for (const proxy of project.proxies || []) {
            const opts = url.parse(proxy.proxyUrl);
            if (proxy.proxyNoAgent) {
                opts.agent = false;
            }
            opts.rejectUnauthorized = !(proxy.rejectUnauthorized === false);
            const proxyMiddleware = yield Promise.resolve().then(() => require('proxy-middleware'));
