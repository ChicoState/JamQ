...
let StartCommand = class StartCommand extends command_1.Command {
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const config = yield this.env.config.load();
            const gitIntegration = config.backend === cli_utils_1.BACKEND_PRO || options['git'] ? yield this.isGitSetup() : false;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!projectExists) {
                ...
                if (confirm) {
                    ...
                    this.env.log.info(`Not erasing existing project in ${chalk_1.default.green(prettyPath(projectDir))}.`);
                    return;
                }
            }
            this.env.tasks.end();
