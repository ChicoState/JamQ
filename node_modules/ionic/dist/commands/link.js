...
let LinkCommand = class LinkCommand extends command_1.Command {
    preRun(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs[0] && create) {
                throw new errors_1.FatalException(`Sorry--cannot use both ${chalk.green('app_id')} and ${chalk.green('--create')}. You must either link an existing app or create a new one.`);
            }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (create || appId === CHOICE_CREATE_NEW_APP) {
                ...
                if (config.backend === cli_utils_1.BACKEND_PRO) {
                    ...
                    appId = app.id;
                    yield this.runcmd(['config', 'set', 'app_id', `"${appId}"`, '--json']);
