        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (project.app_id) {
                const confirm = yield this.env.prompt({
                    type: 'confirm',
                    name: 'confirm',
                    message: `App ID ${chalk_1.default.green(project.app_id)} already exists in project config. Would you like to link a different app?`
                });
                if (!confirm) {
            ...
            if (appId) {
                if (appId === project.app_id) {
                    return this.env.log.info(`Already linked with app ${chalk_1.default.bold(appId)}.`);
                }
                this.env.tasks.next(`Looking up app ${chalk_1.default.bold(appId)}`);
            ...
            if (create || appId === CHOICE_CREATE_NEW_APP) {
                ...
                if (config.backend === cli_utils_1.BACKEND_PRO) {
                    ...
                    this.env.log.ok(`Project linked with app ${chalk_1.default.bold(appId)}!`);
                }
                else {
