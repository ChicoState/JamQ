...
class IonicNamespace extends namespace_1.Namespace {
    constructor() {
        ...
        this.namespaces = new namespace_1.NamespaceMap([
            ...
            ['monitoring', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { MonitoringNamespace } = yield Promise.resolve().then(function () { return require('./monitoring'); }); return new MonitoringNamespace(); })],
        ]);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (command.metadata.backends && !command.metadata.backends.includes(config.backend)) {
                env.log.error(`Sorry! The configured backend (${chalk.bold(config.backend)}) does not know about ${chalk.green('ionic ' + command.metadata.fullName)}.\n` +
                    `You can switch backends with ${chalk.green('ionic config set -g backend')} (choose from ${cli_utils_1.KNOWN_BACKENDS.map(v => chalk.green(v)).join(', ')}).\n`);
                return 1;
            }
