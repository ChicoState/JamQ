...
class MonitoringNamespace extends namespace_1.Namespace {
    constructor() {
        ...
        this.commands = new namespace_1.CommandMap([
            ['syncmaps', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { MonitoringSyncSourcemapsCommand } = yield Promise.resolve().then(() => require('./syncmaps')); return new MonitoringSyncSourcemapsCommand(); })],
        ]);
    }
}
