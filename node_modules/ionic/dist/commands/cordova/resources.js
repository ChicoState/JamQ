        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (platform && !platformEngines.map(p => p.name).includes(platform)) {
                ...
                if (confirm) {
                    ...
                    throw new errors_1.FatalException(`Platform ${chalk.green(platform)} not installed.`);
                }
            }
            ...
            if (buildPlatforms.length === 0) {
                this.env.tasks.end();
                throw new errors_1.FatalException(`No platforms detected. Please run: ${chalk.green('ionic cordova platform add')}`);
            }
