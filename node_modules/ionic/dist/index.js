    ...
    hooks.register(name, 'info', ({ env, project }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (projectFile) {
            if (projectFile.type === 'ionic1') {
                const { getIonic1Version } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/ionic1/utils'));
                ...
                const { getIonicAngularVersion, getAppScriptsVersion } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/ionic-angular/utils'));
            ...
            if (projectFile.integrations.cordova && projectFile.integrations.cordova.enabled !== false) {
                const { getAndroidSdkToolsVersion } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/android'));
                const { getCordovaCLIVersion, getCordovaPlatformVersions } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/cordova/utils'));
            ...
            if (projectFile.integrations.gulp && projectFile.integrations.gulp.enabled !== false) {
                const { getGulpVersion } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/gulp'));
